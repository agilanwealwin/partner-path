  ...
  return (
    <div className="p-4 md:p-6 space-y-4 md:space-y-6">
      ...
      <div className="rounded-card p-6 relative overflow-hidden border-l-4 border-l-status-green bg-surface shadow-surface border border-border">
        ...
        <div className="flex flex-wrap items-center gap-3 sm:gap-6 mt-4 text-[11px]">
          {[
        ...
        <div className="flex flex-wrap items-center gap-2 sm:gap-4 mt-4 text-[10px] text-muted-foreground font-mono">
      ...
      <div className="rounded-card bg-surface p-6 shadow-surface border border-border/50">
        ...
        <div className="relative flex items-start justify-between overflow-x-auto px-2">
          {/* Progress Line */}
